        ...
        <div class="pa-2 left-bottom-container">
          <div class="d-flex flex-row align-center ga-2 mb-3">
            ...
            <CIconBtn label="体重を記録" icon="mdi-pencil" :isTextPrimary="true"
              :onClick="viewmodel.OpenRecordWeightDialog" />
            <RecordWeightDialog v-model="viewmodel.isDialogOpen.value" @update:modelValue="viewmodel.OnRecordWeightDialogClosed"/>
            <CIconBtn label="悩み・目標を設定" icon="mdi-open-in-new" :iconRight="true" :onClick="viewmodel.GoGoalSetting" />
          </div>
